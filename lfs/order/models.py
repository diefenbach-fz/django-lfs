...
class OrderItem(models.Model):
    ...
    external_order_id = models.CharField(_(u"External Order ID"), blank=True, default="", max_length=10)
    external_id = models.CharField(_(u"External ID"), blank=True, default="", max_length=10)
